# ============================================================================
# 文件：unitree_open3d_loc_g1.launch.py
# 说明：宇树 G1（unitree 平台）open3d_loc 局部定位节点启动入口：
#       拉起全局定位节点与定位服务节点，使用 unitree 专用参数文件
#       loc_param_g1_unitree.yaml。
# ============================================================================
...
# 以 loc_param_g1_unitree.yaml 为参数启动全局定位节点与定位服务节点。
