...
namespace rog_map {
    ...
    public:
        ...
        GridType getInflatedGridType(const Vec3f &pos) const;

        bool insideLocalMapPublic(const Vec3f &pos) const;

        bool isMapReady() const;

        void getLocalMapBounds(Vec3f &box_min, Vec3f &box_max) const;
