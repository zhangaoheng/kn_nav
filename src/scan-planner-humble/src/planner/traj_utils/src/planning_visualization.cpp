...
namespace scan_planner
{
  ...
  void PlanningVisualization::displayMarkerList(rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr pub,
  ...
  void PlanningVisualization::displayArrowList(rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr pub,
                                               const vector<Eigen::Vector3d> &list, double scale, Eigen::Vector4d color, int id)
  {
