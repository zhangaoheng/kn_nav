...
namespace scan_planner
{
  ...
  void SCANPlannerManager::initPlanModules(const rclcpp::Node::SharedPtr& node, PlanningVisualization::Ptr vis)
  {
    node_ = node;

    /* read algorithm parameters */

    scan_planner_ros2::getParam(node_, "manager/max_vel", pp_.max_vel_, -1.0);
    scan_planner_ros2::getParam(node_, "manager/max_acc", pp_.max_acc_, -1.0);
    scan_planner_ros2::getParam(node_, "manager/max_jerk", pp_.max_jerk_, -1.0);
    scan_planner_ros2::getParam(node_, "optimization/vel_tolerance", pp_.vel_tolerance_, 1.0);
    scan_planner_ros2::getParam(node_, "optimization/acc_tolerance", pp_.acc_tolerance_, 1.0);
    scan_planner_ros2::getParam(node_, "manager/feasibility_tolerance", pp_.feasibility_tolerance_, 0.0);
    scan_planner_ros2::getParam(node_, "manager/control_points_distance", pp_.ctrl_pt_dist, -1.0);
    scan_planner_ros2::getParam(node_, "manager/planning_horizon", pp_.planning_horizon_, 5.0);
                                        ...
                                        Eigen::Vector3d local_target_vel, bool flag_polyInit, bool flag_randomPolyTraj)
  {
    ...
    rclcpp::Duration t_init = rclcpp::Duration::from_seconds(0.0);
    rclcpp::Duration t_opt = rclcpp::Duration::from_seconds(0.0);
    rclcpp::Duration t_refine = rclcpp::Duration::from_seconds(0.0);
