...
namespace scan_planner_tf2 = tf2_ros;
...
public:
  ...
  bool hasMapObservation();
  bool mapFresh(double timeout_sec);
  bool odomValid();
...
private:
  ...
  shared_ptr<scan_planner_tf2::TransformBroadcaster> tf_broadcaster_;
