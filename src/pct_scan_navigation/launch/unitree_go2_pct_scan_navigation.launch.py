...
#
# 职责：
#   * 固定 config_profile=unitree_go2。
#   * 默认 config_file 指向 /home/code/work_space/kn_nav/src/pct_scan_navigation/config/unitree_go2/navigation.yaml，
...
def generate_launch_description():
    ...
    default_config = '/home/code/work_space/kn_nav/src/pct_scan_navigation/config/unitree_go2/navigation.yaml'
