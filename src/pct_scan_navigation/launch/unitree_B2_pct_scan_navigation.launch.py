# ============================================================================
# unitree_B2_pct_scan_navigation.launch.py
# ----------------------------------------------------------------------------
# 宇树 B2 机型入口 launch：把参数透传给统一的
# local_pct_scan_navigation.launch.py 完成实际节点组装。
#
# 职责：
#   * 固定 config_profile=B2。
#   * 默认 config_file 指向 /home/nav_map/config/B2/navigation.yaml，
#     运行时配置以 /home/nav_map 为唯一数据源（见下方内联注释）。
#   * 透传 navigation_mode / start_go2_bridge / use_sim_time 等全部开关参数。
# ============================================================================

"""Unitree B2 bringup using one unified navigation configuration."""
...
# 并把自身的 LaunchConfiguration 原样转发（config_profile 固定为 B2）。
def generate_launch_description():
    ...
    default_config = '/home/code/work_space/kn_nav/src/pct_scan_navigation/config/B2/navigation.yaml'
